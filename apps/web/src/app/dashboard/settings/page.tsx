...
const SETTINGS_GROUPS: SettingsGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Quick reply templates for ticket comments',
      ...
      },
      {
        ...
        description: 'Form-builder templates for ticket creation',
      ...
      },
      {
        ...
        description: 'Multi-level escalation rules for SLA breaches',
      ...
      },
      {
        ...
        description: 'Conditions that trigger ticket approval workflows',
        icon: mdiCheckDecagram,
        color: '#059669',
      },
      {
        href: '/dashboard/settings/recurring-tickets',
        label: 'Recurring Tickets',
        description: 'Scheduled ticket creation with cron expressions',
