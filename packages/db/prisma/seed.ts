...
// Phase 7 (CREF-01..04 + tenant-lifecycle): the inline seedCmdbReferenceData
// function previously at this location has been extracted to a reusable,
// transaction-aware helper at packages/db/src/seeds/cmdb-reference.ts. The
// helper is imported at the top of this file and invoked inside a
// $transaction wrapper in main(). This keeps the demo-seed behavior identical
// (same 15 CI classes + 11 statuses + 6 environments + 13 relationship types)
// while allowing signup.ts and owner provisioning.ts to reuse the same seeder
// inside their own tenant-creation transactions.
