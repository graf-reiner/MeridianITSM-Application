...
**Plans**: 6 plans
- [x] 07-01-PLAN.md — Wave 0 verification harness (12 test/script files)
- [x] 07-02-PLAN.md — Wave 1 reusable seeder + reference resolver + tenant lifecycle hooks
...
| 7. CI Reference-Table Migration | v2.0 | 4/6 | In Progress|  |
